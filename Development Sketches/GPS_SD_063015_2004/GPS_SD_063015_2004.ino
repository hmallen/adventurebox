...
const int positionPin = A1;  // Change later when in use
const int positionLED = 3;  // Change later when in use
...
void loop() {
  ...
  sdWriteData();
  serialPrintData();
  if (positionMarker == true) positionMarker = false;
}
